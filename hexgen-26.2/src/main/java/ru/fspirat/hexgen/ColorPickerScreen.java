...
public class ColorPickerScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor g, int mouseX, int mouseY, float delta) {
        ...
        g.text(this.font, Component.literal("новый"), px + 3, top + 23, labelColor(currentRgb()), false);
        g.text(this.font, Component.literal("было"), px + 3, top + 49, labelColor(HexCore.rgb(original)), false);

        g.text(this.font, Component.literal("Быстрая палитра"), left, top + 106, 0xFFA0A0A0, false);
        g.text(this.font, Component.literal(RECENT.isEmpty() ? "Недавние: пока пусто" : "Недавние"),
