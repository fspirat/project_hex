...
public class SettingsScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor g, int mouseX, int mouseY, float delta) {
        ...
        g.text(this.font, Component.literal("Открыть генератор из игры: ").append(key), left, top + 116, 0xFFA0A0A0, false);
        g.text(this.font, Component.literal("Сменить: Настройки → Управление → «Разное»"), left, top + 128, 0xFF707070, false);
    }
