...
public class PartColorScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor g, int mouseX, int mouseY, float delta) {
        ...
        g.text(this.font, Component.literal("#" + from), fromButton.getX() + 5, fromButton.getY() + 7, label(from), false);
        if (gradient) {
            ...
            g.text(this.font, Component.literal("#" + to), toButton.getX() + 5, toButton.getY() + 7, label(to), false);
        }
